...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('businesstest_set', 'number')


    def backwards(self, orm):
        
        # Adding field 'Set.number'
        db.add_column('businesstest_set', 'number', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
