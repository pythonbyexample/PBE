...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('businesstest_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Message.body'
        db.add_column('businesstest_message', 'body', self.gf('django.db.models.fields.TextField')(max_length=10000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.subject'
        db.delete_column('businesstest_message', 'subject')

        # Deleting field 'Message.body'
        db.delete_column('businesstest_message', 'body')
