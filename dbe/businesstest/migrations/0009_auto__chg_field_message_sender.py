...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('businesstest_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Message.sender'
        db.alter_column('businesstest_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
