...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('todo_item', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 12, 29), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Item.datetime'
        raise RuntimeError("Cannot reverse this migration. 'Item.datetime' and its values cannot be restored.")

        # Deleting field 'Item.created'
        db.delete_column('todo_item', 'created')
