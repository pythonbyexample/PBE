...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('todo_item', 'created_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todo.DateTime'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Item.created'
        raise RuntimeError("Cannot reverse this migration. 'Item.created' and its values cannot be restored.")
