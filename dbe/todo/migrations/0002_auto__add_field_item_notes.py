...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('todo_item', 'notes', self.gf('django.db.models.fields.TextField')(default='', max_length=3000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.notes'
        db.delete_column('todo_item', 'notes')
    ...
    models = {
        ...
        'todo.item': {
            ...
            'created': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['todo.DateTime']"}),
