...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Msg'
        db.create_table(u'sb_msg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msgs', to=orm['auth.User'])),
            ...
            ('inbox', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('cc', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')(max_length=10000, null=True, blank=True)),
        ))
        db.send_create_signal(u'sb', ['Msg'])


    def backwards(self, orm):
        
        # Deleting model 'Msg'
        db.delete_table(u'sb_msg')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 17, 42, 2, 368405)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 17, 42, 2, 367921)'}),
