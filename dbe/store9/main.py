...
class ModelAdmin:
    """Dummy ModelAdmin providing action_checkbox rendering method for list_display column."""
...
class ChangeList(object):
    def __init__(self, request, model, list_display, list_display_links, list_filter,
        ...
        self.root_query_set = model.objects.filter(user=request.user)
    ...
    def get_query_set(self):
        ...
        if self.search_fields and self.query:
            for bit in self.query.split():
                or_queries = [models.Q(**{construct_search(str(field_name)): bit})
