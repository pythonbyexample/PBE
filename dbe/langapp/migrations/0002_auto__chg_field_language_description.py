...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('langapp_language', 'description', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Language.description'
        raise RuntimeError("Cannot reverse this migration. 'Language.description' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 24, 54, 426306)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 24, 54, 426179)'}),
