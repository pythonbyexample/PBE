...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LanguageProfile.description_intl'
        db.delete_column('langapp_languageprofile', 'description_intl')

        # Adding field 'LanguageProfile.description_native'
        db.add_column('langapp_languageprofile', 'description_native', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LanguageProfile.description_intl'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.description_intl' and its values cannot be restored.")

        # Deleting field 'LanguageProfile.description_native'
        db.delete_column('langapp_languageprofile', 'description_native')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 28, 6, 279201)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 28, 6, 279074)'}),
        ...
        'langapp.languageprofile': {
            ...
            'description_native': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
