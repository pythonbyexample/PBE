...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeResumeStyle.description_eng'
        db.alter_column('langapp_typeresumestyle', 'description_eng', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TypeResumeStyle.description_intl'
        db.alter_column('langapp_typeresumestyle', 'description_intl', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TypeResumeStyle.description_eng'
        raise RuntimeError("Cannot reverse this migration. 'TypeResumeStyle.description_eng' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TypeResumeStyle.description_intl'
        raise RuntimeError("Cannot reverse this migration. 'TypeResumeStyle.description_intl' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 37, 2, 188250)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 37, 2, 188123)'}),
