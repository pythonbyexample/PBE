...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LanguageProfile.language_competency'
        db.alter_column('langapp_languageprofile', 'language_competency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['langapp.TypeLanguageCompetency'], null=True))

        # Changing field 'LanguageProfile.certification_level'
        db.alter_column('langapp_languageprofile', 'certification_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['langapp.TypeLanguageCertification'], null=True))

        # Changing field 'LanguageProfile.spoken_level'
        db.alter_column('langapp_languageprofile', 'spoken_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['langapp.TypeLanguageSpoken'], null=True))

        # Changing field 'LanguageProfile.written_level'
        db.alter_column('langapp_languageprofile', 'written_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['langapp.TypeLanguageWritten'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LanguageProfile.language_competency'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.language_competency' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LanguageProfile.certification_level'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.certification_level' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LanguageProfile.spoken_level'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.spoken_level' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LanguageProfile.written_level'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.written_level' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 20, 51, 298161)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 20, 51, 298029)'}),
