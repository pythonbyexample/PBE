...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TypeResumeStyle', fields ['style']
        db.create_unique('langapp_typeresumestyle', ['style'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TypeResumeStyle', fields ['style']
        db.delete_unique('langapp_typeresumestyle', ['style'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 18, 37, 37, 485980)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 18, 37, 37, 485886)'}),
        ...
        'langapp.typeresumestyle': {
            ...
            'style': ('django.db.models.fields.IntegerField', [], {'unique': 'True'})
        },
        'langapp.typework': {
