...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Flag.information'
        db.alter_column('langapp_flag', 'information', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Flag.description'
        db.alter_column('langapp_flag', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Flag.information'
        raise RuntimeError("Cannot reverse this migration. 'Flag.information' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Flag.description'
        raise RuntimeError("Cannot reverse this migration. 'Flag.description' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 30, 4, 111033)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 10, 30, 4, 110902)'}),
