...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LanguageProfile.description'
        db.delete_column('langapp_languageprofile', 'description')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LanguageProfile.description'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.description' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LanguageProfile.description_native'
        raise RuntimeError("Cannot reverse this migration. 'LanguageProfile.description_native' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 16, 44, 239538)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 13, 14, 16, 44, 239404)'}),
