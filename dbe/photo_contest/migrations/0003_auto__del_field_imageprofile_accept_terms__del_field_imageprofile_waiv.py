...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageProfile.accept_terms'
        db.delete_column(u'photo_contest_imageprofile', 'accept_terms')

        # Deleting field 'ImageProfile.waive_rights'
        db.delete_column(u'photo_contest_imageprofile', 'waive_rights')


    def backwards(self, orm):
        
        # Adding field 'ImageProfile.accept_terms'
        db.add_column(u'photo_contest_imageprofile', 'accept_terms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ImageProfile.waive_rights'
        db.add_column(u'photo_contest_imageprofile', 'waive_rights', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
