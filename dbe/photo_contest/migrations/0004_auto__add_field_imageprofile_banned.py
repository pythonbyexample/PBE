...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageProfile.banned'
        db.add_column(u'photo_contest_imageprofile', 'banned', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageProfile.banned'
        db.delete_column(u'photo_contest_imageprofile', 'banned')
