...
SITE_ROOT               = '/media/Main/Home/Projects/dprojects/dbe/'
MEDIA_ROOT              = '/media/Main/Home/Projects/dprojects/dbe/media/'
MEDIA_URL               = 'http://localhost:8002/media/'
STATIC_ROOT             = '/home/ak/gen9/django1.4/django/contrib/admin/static/'
